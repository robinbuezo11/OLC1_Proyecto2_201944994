...
.					{ 
                        ...
                        errors.push({type:'Léxico', value: 'Este es un error léxico: ' + yytext, line: yylloc.first_line, column: yylloc.first_column});
                    }
...
EXPRESSION: EXPRESSION tern EXPRESSION colon EXPRESSION {$$= INSTRUCTION.newTernary($1, $3, $5, this._$.first_line,this._$.first_column+1)}
        ...
        | Rtruncate parLeft EXPRESSION parRight         {$$= INSTRUCTION.newUnaryOperation($3, OPERATION_TYPE.TRUNCATE,this._$.first_line, this._$.first_column+1);}
